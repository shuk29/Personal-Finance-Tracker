...
class CSV:
    ...
    @classmethod
    def get_transacntion(cls, start_date, end_date):
...
# CSV.initialize_csv()
# CSV.add_entry("30-06-2026", 125, "Income", "Salary")

# add()
# CSV.get_transacntion("01-01-2026", "30-07-2026")
...
def main():
    while True:
        ...
        if choice == "1":
            ...
            df = CSV.get_transacntion(start_date, end_date)
